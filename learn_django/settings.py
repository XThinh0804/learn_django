...
SECRET_KEY = 'django-insecure-m^iqbo$a3j)1&wk!4-43oea7kf82#c1%l+244ow&6ga^lx%%n0'
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'Products', 'description': 'Các API về sản phẩm'},
        {'name': 'Orders', 'description': 'Các API về đơn hàng'},
    ],
    # OTHER SETTINGS
}
